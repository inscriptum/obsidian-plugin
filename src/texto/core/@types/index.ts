import type {Mark as ProseMirrorMark, Node as ProseMirrorNode, ParseOptions} from 'prosemirror-model';
import type {EditorState, Transaction} from 'prosemirror-state';
import type {Decoration, EditorProps, EditorView, NodeView} from 'prosemirror-view';
...
export type NodeViewRenderer = (props: NodeViewRendererProps) => NodeView | object;
...
export type UnionCommands<T extends (...args: any) => any = Command, R = ReturnType<T>> = {
...
export type FocusPosition = 'start' | 'end' | 'all' | 'secondLineStart' | number | boolean | null;
