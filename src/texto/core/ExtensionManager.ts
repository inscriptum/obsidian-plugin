...
export class ExtensionManager {
  ...
  constructor(extensions: Extensions, editor: Editor) {
    ...
    this.extensions.forEach((extension) => {
      ...
      this.editor.extensionStorage[extension.name] =
        extension.storage as AnyRecord;
      ...
      if (extension.type === "mark") {
        const keepOnSplit =
          callOrReturn(getExtensionField(extension, "keepOnSplit", context)) ??
          true;
      ...
      const onSelectionUpdate = getExtensionField<
        AnyConfig["onSelectionUpdate"]
      >(extension, "onSelectionUpdate", context);
  ...
  get plugins(): Plugin[] {
    ...
    const allPlugins = extensions
      .map((extension) => {
        ...
        if (
          extension.type === "mark" &&
          getExtensionField<AnyConfig["exitable"]>(
            extension,
            "exitable",
            context,
          )
