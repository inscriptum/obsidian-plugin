import {Editor, isAtStartOfNode, isNodeActive} from '../../../core';
import {Node} from 'prosemirror-model';

import {findListItemPos} from './findListItemPos';
import {hasListBefore} from './hasListBefore';
import {hasListItemBefore} from './hasListItemBefore';
...
export const handleBackspace = (editor: Editor, name: string, parentListTypes: string[]) => {
	...
	return editor.chain().liftListItem(name).addParagraphBetweenLists().run();
};
